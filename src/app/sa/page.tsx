...
export default function SouthAmericaPage() {
  return (
    <div className="h-[calc(100vh-80px)] bg-gradient-to-br from-green-50 to-emerald-100 flex items-center justify-center overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Sportograf South America
          </h1>
